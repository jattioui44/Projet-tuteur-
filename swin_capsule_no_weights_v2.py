"""
Architecture Hybride Swin + Capsule - VERSION SANS CLASS WEIGHTS
CODE IDENTIQUE à balanced SAUF:
- USE_CLASS_WEIGHTS = False (au lieu de True)
- USE_FOCAL_LOSS = False (au lieu de True)
Tout le reste est IDENTIQUE pour test propre!
"""
...
class Config:
    ...
    #DATA_DIR = "C:/Users/eljat/Desktop/Les Datasets/DDR dataset/DR_grading/DR_grading"
    #CSV_PATH = "C:/Users/eljat/Desktop/Les Datasets/DDR dataset/DR_grading/.csv"
    # Hyperparamètres
    IMG_SIZE = 224
    BATCH_SIZE = 12
    NUM_EPOCHS = 70
    ...
    # Sauvegarde
    BEST_MODEL_PATH = "./best_capsule_no_weights.pth"
...
def main():
    print("\n" + "="*70)
    print("🚀 SWIN + CAPSULE - VERSION SANS CLASS WEIGHTS")
    print("="*70)
    print("CODE IDENTIQUE à balanced SAUF:")
    print("❌ Class Weights: DÉSACTIVÉS")
    print("❌ Focal Loss: DÉSACTIVÉ")
    print("✅ Poids équilibrés: Swin 0.5 / Capsule 0.5")
    print("✅ Architecture: Identique à balanced")
    print("="*70)
    ...
    plt.ylabel('Vraie')
    plt.xlabel('Prédite')
    plt.savefig('confusion_matrix_capsule_no_weights.png', dpi=300, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig('training_curves_capsule_no_weights.png', dpi=300, bbox_inches='tight')
